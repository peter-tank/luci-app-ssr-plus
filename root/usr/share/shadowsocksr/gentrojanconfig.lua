...
local trojan = {
    ...
    ssl = (server.tls) and {
        ...
        sni = (server.tls_host ~= nil) and server.tls_host or (server.ws_host ~=nil and server.ws_host or nil),
    ...
    websocket = (server.trojan_ws) and {
        enabled = true,
        path = (server.ws_path ~= nil) and server.ws_path or "/",
        hostname = server.ws_host,
        obfuscation_password = server.obfuscation_password,
        double_tls = (server.double_tls) and true or false,
